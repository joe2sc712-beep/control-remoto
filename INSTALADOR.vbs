' ==============================================================================
' INSTALADOR INVISIBLE DE UN SOLO CLIC (.VBS) - REVISIÓN TOTAL
' ==============================================================================
...
' Definición de rutas fijas utilizando la ruta especial de Windows directamente
CarpetaC = "C:\ScriptCliente"
LanzadorPs1 = CarpetaC & "\cliente.ps1"
StartupVbs = wshShell.SpecialFolders("Startup") & "\iniciar_cliente.vbs"
...
If fso.FileExists(StartupVbs) Then
    wshShell.Run "wscript.exe " & Chr(34) & StartupVbs & Chr(34), 0, False
End If
